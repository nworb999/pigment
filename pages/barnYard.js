...
const createPigment = (input) => {
  ...
  return (
    <>
      ...
      >
        <g fill="${color}">
          <path d="M337.1,718.3c8.2,32.7,49,85.7,65.3,98h44.9c0,0-16.3-73.4-16.3-81.6C365.7,730.6,337.1,718.3,337.1,718.3z" />
...
const barnYard = (req) => {
  ...
  const pig = createPigment(pigColor || false);
  ...
  return (
    mounted && (
      <>
        ...
        <h1>click on the barn ↓</h1>${pig}
        <button onclick={swapSVG()}>${barn}</button>
      </>
    )
  );
};
